...
const AddUserPage = () => {
    ...
    const [roles, setRoles] = useState(['ADMIN', 'MANAGER', 'TEAM MEMBER', 'User']);
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="phone-input-container">
                                    <PhoneInput
                                        ...
                                        onChange={phone => handleChange(user.id, 'mobileNumber', phone)}
                                        containerClass="!w-full"
                                        inputClass="!w-full !bg-slate-50 dark:!bg-slate-800 !border-2 !border-slate-100 dark:!border-slate-700 !rounded-xl !outline-none focus:!border-emerald-500 !text-sm !font-medium !h-[46px] !pl-12 dark:!text-white"
                                        buttonClass="!bg-transparent !border-2 !border-slate-100 dark:!border-slate-700 !rounded-l-xl"
