...
const MyTasks = () => {
    ...
    const fetchAllData = async () => {
        try {
            ...
            allTasks
                .filter(t => t.doerId === currentUserId)
                .forEach(t => {
                    try {
    ...
    // My tasks = tasks where current user is the DOER
    const myTasks = tasks.filter(t => t.doerId === currentUserId);
    ...
    const handleExport = () => {
        ...
        const exportData = formatTasksForExport(sortedTasks, users);
        exportToExcel(exportData, `My_Tasks_${new Date().toISOString().split('T')[0]}`, 'My Tasks');
    ...
    const quickStats = [
        ...
        { label: 'Completed', value: getStatusCount('Completed'), color: 'text-emerald-600', bg: 'bg-emerald-50', dot: 'bg-emerald-500' },
    ];
        ...
        <div className="min-h-screen bg-[#e6f9f1] p-6 lg:p-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-wrap items-end gap-3 mb-8">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-5 h-11 bg-[#00d094] hover:bg-[#00ba84] text-white rounded-lg font-bold text-sm transition-all shadow-sm self-end"
                >
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative min-w-[140px]">
                            <select
                                ...
                                className="w-full h-11 bg-white border border-slate-200 rounded-lg pl-3 pr-8 text-sm font-bold text-slate-700 outline-none appearance-none cursor-pointer shadow-sm focus:border-[#00d094]"
                            >
                        ...
                        <button 
                            ...
                            className="h-11 w-11 flex justify-center items-center bg-white border border-slate-200 rounded-lg text-slate-500 hover:text-slate-800 transition-colors shadow-sm focus:border-[#00d094]"
