                    ...
                    <div className="p-10 flex-1 flex flex-col">
                        ...
                        <div className="space-y-6 flex-1">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 group phone-input-container">
                                    <PhoneInput
                                        country={'in'}
                                        value={formData.mobileNumber || ''}
                                        onChange={phone => setFormData(prev => ({ ...prev, mobileNumber: phone }))}
                                        containerClass="!flex-1"
                                        inputClass="!w-full !bg-slate-50 dark:!bg-slate-900/50 !border-b-2 !border-slate-200 dark:!border-slate-700 focus:!border-orange-400 dark:focus:!border-orange-500 !px-0 !py-2.5 !pl-12 !text-sm !font-bold !text-slate-800 dark:!text-slate-100 !transition-all !outline-none !h-[42px] !border-t-0 !border-l-0 !border-r-0 !rounded-none"
                                        buttonClass="!bg-transparent !border-b-2 !border-slate-200 dark:!border-slate-700 !rounded-none !border-t-0 !border-l-0 !border-r-0"
