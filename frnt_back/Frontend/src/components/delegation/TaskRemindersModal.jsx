...
const TaskRemindersModal = ({ isOpen, onClose, onSave, initialReminders = [] }) => {
    const [reminders, setReminders] = useState([
        { type: 'both', timeValue: 10, timeUnit: 'minutes', triggerType: 'before' }
    ]);
    ...
    useEffect(() => {
        if (initialReminders && initialReminders.length > 0) {
            ...
            setReminders([{ type: 'both', timeValue: 10, timeUnit: 'minutes', triggerType: 'before' }]);
        }
    ...
    const addReminder = () => {
        setReminders([...reminders, { type: 'both', timeValue: 10, timeUnit: 'minutes', triggerType: 'before' }]);
    };
