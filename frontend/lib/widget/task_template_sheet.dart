  ...
  Future<void> _submitTemplate() async {
    ...
    if (title.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Focus Title is required')),
      );
      return;
    }
    ...
    try {
      ...
      if (widget.template != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Template updated successfully!'), backgroundColor: Colors.green),
          );
        }
      } else {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Template created successfully!'), backgroundColor: Colors.green),
          );
        }
      }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Builder(builder: (context) {
                              return AppDropdown<String>(
                                ...
                                items: ['Category', ...catProvider.categoryModels.map((c) => c.name)],
                    ...
                    Row(
                      children: [
                        const Icon(Icons.add, size: 20, color: Color(0xFF20E19F)),
                        const SizedBox(width: 12),
                        Expanded(
                          child: TextField(
                        ...
                        TextButton(
                          ...
                          child: const Text('Add', style: TextStyle(color: Color(0xFF20E19F), fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
