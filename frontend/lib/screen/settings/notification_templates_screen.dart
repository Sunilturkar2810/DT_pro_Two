...
class _NotificationTemplatesScreenState extends State<NotificationTemplatesScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("NOTIFICATION TEMPLATES", 
          style: TextStyle(color: Color(0xFF1E293B), fontWeight: FontWeight.black, fontSize: 14, letterSpacing: 1.2)
        ),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              border: Border(right: BorderSide(color: Colors.slate.shade100)),
            ),
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Text("EVENT TYPES", 
                    style: TextStyle(fontSize: 10, fontWeight: FontWeight.black, color: Color(0xFF94A3B8), letterSpacing: 1.5)
                  ),
                ),
                Expanded(
                  child: ListView(
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text("${_events[_activeEvent]} ${_activeChannel.toUpperCase()}".toUpperCase(),
                                style: const TextStyle(fontSize: 18, fontWeight: FontWeight.black, color: Color(0xFF1E293B))
                              ),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                const Text("ACTIVE", style: TextStyle(fontSize: 10, fontWeight: FontWeight.black, color: Color(0xFF64748B), letterSpacing: 1)),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      const Icon(LucideIcons.info, size: 16, color: Color(0xFF059669)),
                                      const SizedBox(width: 10),
                                      Expanded(
                                        child: Text(
                                          "Click a variable to insert it into your ${_activeChannel == 'whatsapp' ? 'message' : 'email body'}.",
                                      ...
                                      return InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(v['key']!, 
                                                style: const TextStyle(fontSize: 11, fontWeight: FontWeight.black, color: Color(0xFF059669))
                                              ),
  ...
  Widget _buildSectionLabel(String text) {
    return Padding(
      ...
      child: Text(text, 
        style: const TextStyle(fontSize: 10, fontWeight: FontWeight.black, color: Color(0xFF94A3B8), letterSpacing: 1.2)
      )
    );
  }
  ...
  InputDecoration _inputDeco(String hint) {
    return InputDecoration(
      hintText: hint,
      hintStyle: TextStyle(color: Colors.slate.shade400, fontWeight: FontWeight.w500),
      filled: true,
      fillColor: Colors.white,
      contentPadding: const EdgeInsets.all(20),
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: Colors.slate.shade100)),
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: Colors.slate.shade100)),
