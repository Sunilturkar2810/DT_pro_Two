...
class _RolePermissionScreenState extends State<RolePermissionScreen> {
  ...
  Map<String, dynamic> _normalizedPermissionsForRole(Map<String, dynamic> role) {
  ...
  Future<void> _saveAllChanges(
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(overallSuccess ? 'Permissions saved successfully!' : 'Some permission updates failed.'),
    ...
    return Scaffold(
      ...
      body: Consumer<RolesProvider>(
        builder: (context, provider, _) {
          ...
          final defaultRoles = roles.where((role) => role['isCustom'] != true).toList();
          final customRoles = roles.where((role) => role['isCustom'] == true).toList();
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () => _saveAllChanges(provider, defaultRoles),
                          ...
                          child: ConstrainedBox(
                            ...
                            child: Column(
                              ...
                              children: _modules.map((module) {
                                return _buildModuleSection(module, defaultRoles);
                              }).toList(),
                            ),
                          ),
                        ),
  ...
  Widget _buildModuleSection(Map<String, dynamic> module, List<Map<String, dynamic>> roles) {
  ...
  Widget _buildCellContent(Map<String, dynamic> role, String moduleKey, Map<String, dynamic> action) {
    final roleId = _roleId(role);
    ...
    if (type == 'bool') {
      ...
      final options = _roleAwareOptions(role, moduleKey, actionKey, currentValue);
      final val = currentValue is String && options.contains(currentValue) ? currentValue : options.first;
        ...
        child: Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              onChanged: isLocked ? null : (newVal) {
                ...
                children: [
                  ...
                  if (action['type'] == 'bool')
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: currentValue == true || currentValue == 'true'
                              ? const Color(0xFF25D458)
                              : Colors.transparent,
                          border: Border.all(color: const Color(0xFFC7D3E3), width: 1.6),
                        ),
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          value: currentValue is String &&
                                  _baseOptions(moduleKey, actionKey).contains(currentValue)
                              ? currentValue
  ...
  Future<void> _showRoleDialog(
    ...
    final controller = TextEditingController(text: roleToEdit?['name']?.toString() ?? '');
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(16),
                              borderSide: const BorderSide(color: Color(0xFF25D458), width: 1.5),
                            ),
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(16),
                              borderSide: const BorderSide(color: Color(0xFF25D458), width: 1.8),
                            ),
                          ),
                        ),
                        ...
                        ..._modules.map(
                          (module) => _buildDialogPermissionSection(
                            ...
                            (moduleKey, actionKey, value) {
                              setDialogState(() {
                                final modulePerms = dialogPermissions[moduleKey] is Map
                                    ? Map<String, dynamic>.from(dialogPermissions[moduleKey])
                                    : <String, dynamic>{};
                            ...
                            SnackBar(
                              content: Text(
                                success
                                    ...
                                    : (rolesProvider.errorMessage ?? 'Unable to save role'),
                              ),
                              backgroundColor:
                                  success ? const Color(0xFF20E19F) : Colors.redAccent,
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(0xFF25D458),
                          foregroundColor: Colors.white,
                          padding: const EdgeInsets.symmetric(horizontal: 22, vertical: 14),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                        ),
                        child: Text(roleToEdit == null ? 'Create Role' : 'Save Changes'),
                      ),
                    ],
                  ),
                ),
  ...
  Widget _buildTabButton(String value, String label) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive ? const Color(0xFF20E19F) : Colors.transparent,
          borderRadius: BorderRadius.circular(10),
        ),
        child: Text(
          label,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    role['description']?.toString().trim().isNotEmpty == true
