                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: Text("DATE RANGE", style: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, color: Color(0xFF94A3B8), letterSpacing: 0.5)),
                            ),
                            SizedBox(
                              width: 140,
                              child: AppDropdown<String>(
                                ...
                                items: const ['This Month', 'Today', 'This Week', 'All Time'],
                        ...
                        Column(
                          ...
                          children: [
                            const Padding(
                              padding: EdgeInsets.only(left: 4.0, bottom: 6),
                              child: Text("UPDATED BY", style: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, color: Color(0xFF94A3B8), letterSpacing: 0.5)),
                            ),
                            SizedBox(
                              width: 160,
                              child: AppDropdown<dynamic>(
                                ...
                                labelBuilder: (val) {
                                  ...
                                  final user = provider.usersList.firstWhere((u) => (u.id == val), orElse: () => null as dynamic);
                                  return user != null ? '${user.firstName} ${user.lastName}' : val.toString();
                                },
                                accentColor: primary,
                                onChanged: (val) {
                        ...
                        Column(
                          ...
                          children: [
                            const Padding(
                              padding: EdgeInsets.only(left: 4.0, bottom: 6),
                              child: Text("SEARCH", style: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, color: Color(0xFF94A3B8), letterSpacing: 0.5)),
                            ),
                            Container(
                              width: 150,
                              height: 42,
                              ...
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  hintText: 'Search...',
                                  hintStyle: TextStyle(fontSize: 13, color: Colors.grey, fontWeight: FontWeight.normal),
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                radius: 18,
                                backgroundColor: index % 2 == 0 ? const Color(0xFF3B82F6).withOpacity(0.1) : const Color(0xFFEF4444).withOpacity(0.1),
                                child: Text(initials, style: TextStyle(color: index % 2 == 0 ? const Color(0xFF3B82F6) : const Color(0xFFEF4444), fontWeight: FontWeight.w900, fontSize: 12)),
                              ),
                              const SizedBox(width: 12),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                children: [
                                  Text('$count', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Color(0xFF1E293B))),
                                  Text(user.firstName.toUpperCase(), style: const TextStyle(fontSize: 9, color: Color(0xFF64748B), fontWeight: FontWeight.w900)),
                                ],
                              )
                            ],
                          ),
                          ...
                          ? Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Text("No Activities Found", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16, color: Color(0xFF1E293B))),
                                  const Text("Try adjusting your filters", style: TextStyle(color: Color(0xFF64748B), fontSize: 13)),
                                ],
                              ),
                            )
                          : ListView.builder(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: act.relatedId != null ? () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) => ActivityTaskDetailScreen(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: _getActivityIconColor(act.type).withOpacity(0.1),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: const TextStyle(fontSize: 9, color: Color(0xFF94A3B8), fontWeight: FontWeight.w900),
                                              ),
                                              if (act.relatedId != null)
                                                const Padding(
                                                  padding: EdgeInsets.only(top: 4),
                                                  child: Icon(Icons.arrow_forward_ios_rounded, size: 10, color: Color(0xFFCBD5E1)),
                                                ),
                                            ],
                                          ),
                                        ],
